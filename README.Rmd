...
> Until a more stable release of `olfactometeR` is released please fork this repo and use your version to ensure some semblance of stability. Changes made here are likely to be sporadic but drastic. Otherwise, use this repo at your own discression! 
...
There are a number of features I intend to develop for `olfactometeR` to help streamline data analysis and visualisation for behavioural experiments using olfactometery. If you have any suggestions or if you discover any issues please report them! 
